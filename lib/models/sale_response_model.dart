...
class SaleModel {
    ...
    factory SaleModel.fromJson(Map<String, dynamic> json) => SaleModel(
        id: json["_id"],
        customer: json["customer"] == null ? null : CustomerByRouteModel.fromJson(json["customer"]),
        saleBy: json["saleBy"] == null ? null : UserModel.fromJson(json["saleBy"]),
        ...
        returnProducts: json["returnProducts"] == null ? [] : List<ProductElement>.from(json["returnProducts"]!.map((x) => ProductElement.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "returnProducts": returnProducts == null ? [] : List<dynamic>.from(returnProducts!.map((x) => x.toJson())),
